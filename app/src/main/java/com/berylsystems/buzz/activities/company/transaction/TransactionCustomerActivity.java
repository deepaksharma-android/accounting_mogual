...
import com.berylsystems.buzz.adapters.TransactionCustomerAdapter;
...
public class TransactionCustomerActivity extends AppCompatActivity{
    ...
    public void getTransactionCustomer(GetAccountResponse response) {
        ...
        if (response.getStatus() == 200) {
            ...
            listAdapter = new TransactionCustomerAdapter(this, listDataHeader, listDataChild,amountList);
    ...
    public void ClickEventCashInHandList(EventReport pos) {
        ...
        Intent intent = new Intent(getApplicationContext(), CustomerReportActivity.class);

...
public class EditSaleReturnActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_sale_return);
    ...
    private void initActionbar() {
        ...
        actionbarTitle.setText("EDIT SALE RETURN ACTIVITY");

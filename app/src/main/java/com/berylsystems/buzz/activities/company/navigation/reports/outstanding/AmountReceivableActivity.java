package com.berylsystems.buzz.activities.company.navigation.reports.outstanding;
...
public class AmountReceivableActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amount_receivable);
    ...
    private void initActionbar() {
        ...
        actionbarTitle.setText("AMOUNT RECEIVABLE ACTIVITY");

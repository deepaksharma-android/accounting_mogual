...
public class AmountPaybleActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amount_payble);
    ...
    private void initActionbar() {
        ...
        actionbarTitle.setText("AMOUNT PAYABLE ACTIVITY");

...
public class TransactionSalesAdapter extends BaseExpandableListAdapter {
    ...
    public TransactionSalesAdapter(Context context, List<String> _listDataHeader, HashMap<String,List<String>> _listDataChild, ArrayList addAmount, ArrayList addQuantity){
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.list_group_transaction_sales, null);
        }

...
public class PurchaseReturnVoucherDetailsBillSundry {
    ...
    public String getBill_sundry() {
        return bill_sundry;
    }

    public void setBill_sundry(String bill_sundry) {
        this.bill_sundry = bill_sundry;
    }
    ...
    public Boolean getConsolidate_bill_sundry() {
    ...
    public int getBill_sundry_nature_id() {
        return bill_sundry_nature_id;
    }

    public void setBill_sundry_nature_id(int bill_sundry_nature_id) {
        this.bill_sundry_nature_id = bill_sundry_nature_id;
    }
    ...
    public Double getBill_sundry_percentage_value() {
        return bill_sundry_percentage_value;
    }

    public void setBill_sundry_percentage_value(Double bill_sundry_percentage_value) {
    ...
    public int bill_sundry_nature_id;
    public String bill_sundry_nature;
    public Double bill_sundry_percentage_value;
    public Double percentage;
    public Double previous_amount;
}
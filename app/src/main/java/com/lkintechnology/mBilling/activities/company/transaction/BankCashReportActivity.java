...
public class BankCashReportActivity extends RegisterAbstractActivity implements View.OnClickListener{
            ...
            public void onClick(View view) {
                ...
                if(!mAccount_group_textview.getText().toString().equals("")) {
                    if (Helpers.dateValidation(start, end) == -1) {
                        Helpers.dialogMessage(BankCashReportActivity.this, "End date should be greater than start date!");
                        return;
                    } else {
                        ...
                        if (isConnected) {
                            mProgressDialog = new ProgressDialog(BankCashReportActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
               /* Intent intent = new Intent(this, TransactionBankActivity.class);

...
import com.lkintechnology.mBilling.adapters.IncomeListAdapter;
...
public class IncomeActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dashboardSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                appUser.income_duration_spinner=selectedItemText;
                LocalRepositories.saveAppUser(getApplicationContext(),appUser);
    ...
    public void getIncome(GetIncomeResponse response){
        ...
        if(response.getStatus()==200) {
            if (response.getIncomes().getData().size() == 0) {
   ...
   /* public void add(View v) {
    ...
    public void showpopup(){
        dialog = new Dialog(IncomeActivity.this);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Helpers.dateValidation(start, end) == -1) {
                    Helpers.dialogMessage(IncomeActivity.this, "End date should be greater than start date!");
                    return;
                } else {

...
public class SaleRegisterActivity extends RegisterAbstractActivity implements View.OnClickListener{
        ...
        mSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Helpers.dateValidation(start, end) == -1) {
                    Helpers.dialogMessage(SaleRegisterActivity.this, "End date should be greater than start date!");
                    return;
                } else {
    ...
    private void initActionbar() {
        ...
        actionbarTitle.setText("SALE REGISTER");

...
public class ExpenceActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void showpopup(){
        dialog = new Dialog(ExpenceActivity.this);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Helpers.dateValidation(start, end) == -1) {
                    Helpers.dialogMessage(ExpenceActivity.this, "End date should be greater than start date!");
                    return;
                } else {

...
import com.lkintechnology.mBilling.adapters.GetPurchaseReturnListAdapter;
...
public class GetPurchaseReturnListActivity extends RegisterAbstractActivity implements View.OnClickListener{
    ...
    GetPurchaseReturnListAdapter mAdapter;
    ...
    public void getpdf(EventShowPdf pos){
        ...
        String type=arr[0];
        if(type.equals("purchase-return-vouchers")){
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Helpers.dateValidation(start, end) == -1) {
                    Helpers.dialogMessage(GetPurchaseReturnListActivity.this, "End date should be greater than start date!");
                    return;
                } else {

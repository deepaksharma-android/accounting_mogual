...
public class CashInHandReportActivity extends RegisterAbstractActivity implements View.OnClickListener{
            ...
            public void onClick(View view) {
                ...
                if(!mAccount_group_textview.getText().toString().equals("")) {
                    if (Helpers.dateValidation(start, end) == -1) {
                        Helpers.dialogMessage(CashInHandReportActivity.this, "End date should be greater than start date!");
                        return;
                    } else {
                        ...
                        if (isConnected) {
                            mProgressDialog = new ProgressDialog(CashInHandReportActivity.this);

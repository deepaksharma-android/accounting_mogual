...
public class SaleVouchersItemDetailsListActivity extends RegisterAbstractActivity {
    ...
    protected void onResume() {
        ...
        if (isConnected) {
            mProgressDialog = new ProgressDialog(SaleVouchersItemDetailsListActivity.this);
            mProgressDialog.setMessage("Info...");
            mProgressDialog.setIndeterminate(false);
            mProgressDialog.setCancelable(true);
            mProgressDialog.show();
            LocalRepositories.saveAppUser(getApplicationContext(), appUser);
            ApiCallsService.action(getApplicationContext(), Cv.ACTION_GET_SALE_VOUCHERS_ITEM_DETAILS);
        } else {
            snackbar = Snackbar
    ...
    private void initActionbar() {
       ...
       // spinner.setVisibility(View.VISIBLE);
        actionbarTitle.setText("Sales Vouchers Item Details");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent = new Intent(this, TransactionSalesActivity.class);
    ...
    @Subscribe
    public void getSaleVouchersItemDetails(GetSaleVoucherListResponse response){
    ...
    public void deletesalevoucher(EventDeleteSaleVoucher pos){
        ...
        new AlertDialog.Builder(SaleVouchersItemDetailsListActivity.this)

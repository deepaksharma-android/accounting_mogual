...
public class EditPurchaseReturnActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_purchase_return);
    ...
    private void initActionbar() {
        ...
        actionbarTitle.setText("EDIT PURCHASE RETURN ACTIVITY");

...
import com.lkintechnology.mBilling.adapters.TransactionSupplierAdapter;
...
public class TransactionSupplierActivity extends AppCompatActivity{
    ...
    TransactionSupplierAdapter listAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transaction_supplier);
    ...
    protected void onResume() {
        ...
        if (isConnected) {
            mProgressDialog = new ProgressDialog(TransactionSupplierActivity.this);
    ...
    @Subscribe
    public void getTransactionSupplier(GetAccountResponse response) {
        ...
        if (response.getStatus() == 200) {
            ...
            for (int i = 0; i < response.getOrdered_accounts().size(); i++) {
                ...
                for (int j = 0; j < response.getOrdered_accounts().get(i).getData().size(); j++) {
                    if(response.getOrdered_accounts().get(i).getData().get(j).getAttributes().getAmount()!=0.00) {
            ...
            listAdapter = new TransactionSupplierAdapter(this, listDataHeader, listDataChild,amountList);
    ...
    public void ClickEventCashInHandList(EventReport pos) {
        ...
        Intent intent = new Intent(getApplicationContext(), SupplierReportActivity.class);
   ...
   /* @Subscribe
    public void deletegroup(EventDeleteAccount pos) {
        ...
        LocalRepositories.saveAppUser(this, appUser);
        new AlertDialog.Builder(TransactionSupplierActivity.this)
...
*/
    ...
    private void initActionbar() {
        ...
        actionbarTitle.setText("Suppliers");

...
//
	...
	{
		bluetoothSocket.getOutputStream().write(CARRIAGE_RETURN);
	}
...
//		
		...
		bluetoothSocket.getOutputStream().write(text.getBytes(), 0,
	...
	public void printBarcode(String barcodeData, BARCODE_TYPE barcodetype, BARCODE_HEIGHT barcodeheight) throws IOException
{
	...
	public void printImage(Bitmap originalBitmap) throws IOException
	{
		...
		PrintRasterImage.PrepareImage(com.lkintechnology.mBilling.activities.printerintegration.PrintRasterImage.dither.floyd_steinberg, 128);

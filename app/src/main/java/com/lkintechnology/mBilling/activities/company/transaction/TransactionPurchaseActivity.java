...
public class TransactionPurchaseActivity extends RegisterAbstractActivity implements View.OnClickListener{
    ...
    private void initActionbar() {
       ...
       // spinner.setVisibility(View.VISIBLE);
        actionbarTitle.setText("Purchase Vouchers Item");
    ...
    protected void onResume() {
        ...
        if (isConnected) {
            mProgressDialog = new ProgressDialog(TransactionPurchaseActivity.this);
            mProgressDialog.setMessage("Info...");
            mProgressDialog.setIndeterminate(false);
            mProgressDialog.setCancelable(true);
            mProgressDialog.show();
            LocalRepositories.saveAppUser(getApplicationContext(), appUser);
            ApiCallsService.action(getApplicationContext(), Cv.ACTION_GET_PURCHASE_VOUCHERS_ITEM);
        } else {
            snackbar = Snackbar
    ...
    public void showpopup(){
        dialog = new Dialog(TransactionPurchaseActivity.this);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Helpers.dateValidation(start, end) == -1) {
                    Helpers.dialogMessage(TransactionPurchaseActivity.this, "End date should be greater than start date!");
                    return;
                } else {

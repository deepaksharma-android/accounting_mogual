...
//					}
	...
	private void readPacketFromPrinter(char ch) 
	{
		try 
		{
			...
			else if ((buffer.contains("NOPAPER"))|| (buffer.contains("LOWBATT"))||(buffer.contains("BATCHG"))||(buffer.contains("PWR_OFF"))|| (buffer.contains("PAPEROK"))|| (buffer.contains("HIGHTEMP"))) 
			{

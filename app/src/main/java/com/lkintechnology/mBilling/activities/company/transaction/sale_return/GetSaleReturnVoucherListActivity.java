...
import com.lkintechnology.mBilling.adapters.GetSaleReturnVoucherListAdapter;
...
public class GetSaleReturnVoucherListActivity extends RegisterAbstractActivity implements View.OnClickListener{
    ...
    GetSaleReturnVoucherListAdapter mAdapter;
    ...
    protected int layoutId() {
        return R.layout.activity_get_sale_return_voucher_list;
    }
    ...
    private void initActionbar() {
       ...
       // spinner.setVisibility(View.VISIBLE);
        actionbarTitle.setText("SALE RETURN VOUCHER");
    ...
    @Subscribe
    public void deletesalevoucher(EventDeleteSaleReturnVoucher pos){
        appUser.delete_sale_return_voucher_id= pos.getPosition();
        LocalRepositories.saveAppUser(this,appUser);
        new AlertDialog.Builder(GetSaleReturnVoucherListActivity.this)
    ...
    public void getpdf(EventShowPdf pos){
        ...
        String type=arr[0];
        if(type.equals("sale-return-vouchers")){
            type="Sale Return";
        }
        String id=arr[1];

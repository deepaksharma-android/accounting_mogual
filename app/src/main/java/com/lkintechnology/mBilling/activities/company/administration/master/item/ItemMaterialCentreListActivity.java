...
import com.lkintechnology.mBilling.activities.company.administration.master.materialcentre.CreateMaterialCentreActivity;
...
import com.lkintechnology.mBilling.adapters.ItemMaterialCenterListAdapter;
...
public class ItemMaterialCentreListActivity extends AppCompatActivity {
    ...
    ItemMaterialCenterListAdapter listAdapter;
    ...
    protected void onResume() {
        ...
        if (isConnected) {
            mProgressDialog = new ProgressDialog(ItemMaterialCentreListActivity.this);
    ...
    public void getCreateMaterialList(GetMaterialCentreListResponse response) {
        ...
        if (response.getStatus() == 200) {
            ...
            listAdapter = new ItemMaterialCenterListAdapter(this, listDataHeader, listDataChild);
    ...
    @Subscribe
    public void clickEvent(EventItemMaterialCenterClick pos) {
            ...
            String childid = arr[1];
            String arrid = listDataChildId.get(Integer.parseInt(groupid)).get(Integer.parseInt(childid));
            Preferences.getInstance(getApplicationContext()).setStoreId(arrid);
            Intent intentForward = new Intent(getApplicationContext(), TransactionStockInHandActivity.class);

package com.lkintechnology.mBilling.activities.company.navigations.reports.saleanalysis;
...
import com.lkintechnology.mBilling.adapters.SaleReportAdapter;
...
public class AnalysisSaleReportActivity extends RegisterAbstractActivity implements View.OnClickListener{
    ...
    public void deletesalevoucher(EventDeleteSaleVoucher pos){
        ...
        new AlertDialog.Builder(AnalysisSaleReportActivity.this)
    ...
    public void showpopup(){
        dialog = new Dialog(AnalysisSaleReportActivity.this);

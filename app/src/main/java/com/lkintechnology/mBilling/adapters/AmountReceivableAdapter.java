...
public class AmountReceivableAdapter extends BaseExpandableListAdapter {
    ...
    public AmountReceivableAdapter(Context context, List<String> _listDataHeader, HashMap<String,List<String>> _listDataChild, ArrayList addAmount){
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.list_group_amount_receivable, null);
        }
    ...
    public View getChildView(int groupPosition, int childPosititon, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = layoutInflater.inflate(R.layout.list_item_amont_receivable,null);
        }
        ...
        mMainLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EventBus.getDefault().post(new EventAmountReceivable(id));
            }
        });

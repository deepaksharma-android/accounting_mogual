...
public class ItemMaterialCenterListAdapter extends BaseExpandableListAdapter {
    ...
    public  ItemMaterialCenterListAdapter(Context context, List<String> listDataHeader,
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        mainLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String id=groupPosition+","+childPosition;
                EventBus.getDefault().post(new EventItemMaterialCenterClick(id));

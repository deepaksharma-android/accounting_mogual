...
public class GetPurchaseReturnListAdapter extends RecyclerView.Adapter<GetPurchaseReturnListAdapter.ViewHolder> {

    private Context context;
    private ArrayList<Data> data;

    public GetPurchaseReturnListAdapter(Context context, ArrayList<Data> data){
        this.context=context;
        this.data=data;
    }

    @Override
    public GetPurchaseReturnListAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {

        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_purchase_return_list, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(GetPurchaseReturnListAdapter.ViewHolder viewHolder, int position) {
